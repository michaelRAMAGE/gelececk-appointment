...
const NotePage = () => {
  return (
    <div className="note-container">
      ...
      <p>
        And I do find myself missing you tbh, even though I don't respond to you and tell you that in return when you told me you miss me or whatever. I mean, some parts could be explained, but not really trying to go overboard with how much I am typing here. So this is in part to say my bad for making you feel that i am ghosting you, for being inconsistent (something i need to work on), and not being very clear (need to work on but also a lot more to it). I promise I do appreciate the time you have given me and for teaching me things about you directly and indirectly (sometimes i experiment on you lowkey *in a non dangerous way* just to see how you think too tbh). Also, my bad for typing all this and i swear i had this organized the other day and it was a lot more clear but now it is just a flow of spontane thoughts.
      </p>
    </div>
  );
};
