...
const GettinFoodStory = () => {
  const [currentImage, setCurrentImage] = useState(0);
  
  const images = [
    process.env.PUBLIC_URL + "/images/gettinfood1.png", 
    process.env.PUBLIC_URL + "/images/gettinfood2.png"
  ];
  ...
  return (
    ...
    <h3>once upon a time someone said "getting food real quick"...</h3>
...
export default GettinFoodStory;
